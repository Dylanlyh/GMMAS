...
parser.add_argument('--valid_file', default='IDH_valid_1.txt', type=str) 
...
resume = "/public/home/hpc226511030/GMMAS/checkpoint_mix_12.06/TransBraTS_IDH2024-01-16/model_epoch_3.pth"
...
ub_list = os.path.join(ub_root, 'IDH_valid_1.txt')
unlabel_set = BraTS(ub_list, ub_root, 'test')
...
infer.grade_uncertainty_ECE(pseudo_loader,model_PL,names,args)

logging.info('----------------------------------The process finished!-----------------------------------')